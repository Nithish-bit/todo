...
import 'package:todo/app/data/services/notification_service.dart';
import 'package:todo/app/modules/home/views/dashboard_view.dart';
import 'package:todo/app/modules/home/views/today_task_view.dart';
...
class HomeController extends GetxController {
  ...
  void onInit() async {
    ...
    slideC = SlidableController(ticker!);
    selectedDate = DateTime.now();
    dateController!.text = DateFormat.yMMMd().format(selectedDate!);
    selectedTime = TimeOfDay(hour: 00, minute: 00);
    timeController!.text = formatDate(
